				...
				<div id="board">
					<div id="list">
						...
						<table>
							...
							<tbody>
								<c:forEach items="${listMap.boardList}" var="boardList">
									<tr>
										<td>${boardList.no}</td>
										<td class="text-left"><a
											href="${pageContext.request.contextPath }/board/read?no=${boardList.no}">${boardList.title}</a></td>
										<td>${boardList.name }</td>
										<td>${boardList.hit }</td>
										<td>${boardList.regDate }</td>
										<c:if test="${authUser.no eq boardList.userNo }">
										<td><a
											href="${pageContext.request.contextPath }/board/delete?no=${boardList.no}">[삭제]</a></td>
